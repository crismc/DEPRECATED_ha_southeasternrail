...
class SoutheasternConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(self, user_input=None):
        ...
        if user_input is not None:
            ...
            self.data_config[CONF_TIME_WINDOW] = str(DEFAULT_TIME_WINDOW)
        ...
        data_schema = {
            ...
            vol.Required(CONF_TIME_OFFSET, default=str(DEFAULT_TIME_OFFSET)): str,
            # vol.Required(CONF_TIME_WINDOW, default=str(DEFAULT_TIME_WINDOW)): str,
        }
